"""
Django settings for tpvCommerce project.
...
SECRET_KEY = '5!_we&2)ld-xuwmd$g#98h6(d@d(n#_y+b_zqxlzuvzhc8-h0j'
...
WSGI_APPLICATION = 'tpvCommerce.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'HOST': os.environ.get('POSTGRES_SERVICE_HOST', '192.168.99.100'), # noqa
